...
function App() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Replace HTTP with HTTPS to ensure the URL is correct for production
      setAudioUrl(res.data.audioUrl.replace('http://localhost:5000', 'https://readaloud-tbqf.onrender.com'));
